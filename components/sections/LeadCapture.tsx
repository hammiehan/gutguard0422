  ...
  return (
    <section className="bg-[#020B41] py-16 sm:h-[459.66px] sm:py-0">
      <div className="mx-auto flex h-full w-full max-w-[1040px] items-center px-4 sm:px-6 lg:px-0">
        <div className="relative w-full rounded-[20px] border border-[rgba(255,255,255,0.20)] bg-[rgba(255,255,255,0.04)] px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,0.16)] sm:h-[259.66px] sm:px-0 sm:py-0">
          <div className="flex flex-col gap-6 sm:block">
            <div className="space-y-[17px] sm:absolute sm:left-[45px] sm:top-[50px] sm:w-[424.87px]">
              <h2
                className={[
                  plusJakartaSans.className,
                  "text-[28px] font-bold leading-[46.2px] tracking-[-0.56px] text-white sm:h-[81.19px] sm:w-[424.87px]",
                ].join(" ")}
              >
              ...
              <p
                className={[
                  inter.className,
                  "text-[14px] font-normal leading-[23.1px] tracking-[0] text-[#A3A3A8] sm:h-[63.19px] sm:w-[387.49px]",
                ].join(" ")}
              >
            ...
            <div className="sm:absolute sm:left-[553.41px] sm:top-[91.75px] sm:h-[91px] sm:w-[441.59px]">
              <form className="flex w-full flex-col gap-3 sm:h-[48px] sm:flex-row sm:items-center sm:gap-[10px]">
                <input
                  className={[
                    inter.className,
              ...
              <p
                className={[
                  inter.className,
                  "mt-3 text-[11px] font-normal leading-[18.15px] tracking-[0] text-[#7E7E84] sm:mt-[12.75px] sm:h-[14px] sm:w-[275.97px]",
                ].join(" ")}
              >
