        ...
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-16">
          <div className="max-w-xl space-y-7">
            ...
            <div className="space-y-5">
              <h1
                className={[
                  ...
                  "max-w-[16rem] text-[3.5rem] font-extrabold leading-[0.94] tracking-[-0.04em] text-[#020B41]",
                  "sm:max-w-[20rem] sm:text-[4.5rem]",
                  "lg:max-w-[504px] lg:text-[84px] lg:leading-[84px] lg:tracking-[-3.36px]",
                ].join(" ")}
              >
                <span className="text-[#020B41]">Most supplements are a guess.</span>{" "}
                <span className="text-[#0305C6]">Your blood is not.</span>
              </h1>
              <p className="max-w-[490.45px] text-[18px] font-normal leading-[31.5px] tracking-[0] text-[#44444A]">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <Button
                className="h-[54px] min-w-[221.17px] bg-[#0305C6] px-6 py-0 text-[14px] font-semibold text-white hover:bg-[#0204a8]"
                href="#plans"
              >
                Check My Score →
              </Button>
            ...
            <ul className="space-y-2">
              {heroBullets.map((bullet) => (
                <li key={bullet.label} className="flex items-center gap-2 text-sm text-[#616b8e]">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#eef4ff] text-xs text-[#3047f8]">
                    ✓
                  </span>
          ...
          <div className="relative mx-auto w-full max-w-[34rem]">
            ...
            <div className="relative mx-auto min-h-[611.61px] w-full max-w-[450.86px] rounded-[20px] border border-[rgba(255,255,255,0.13)] bg-white/95 px-5 py-6 shadow-[0_24px_70px_rgba(12,18,80,0.18)] sm:px-6 sm:py-7">
              <div className="space-y-6">
                ...
                <Button
                  className="h-[42px] w-full bg-[#171bdb] py-0 text-[13px] font-semibold hover:bg-[#1116b8]"
                  href="#plans"
                >
                  Get My Real Score →
                </Button>
